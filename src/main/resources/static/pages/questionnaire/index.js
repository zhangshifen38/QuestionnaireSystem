...
const fetchProjectList = () => {
  console.log($util.getItem('userInfo').username)
  let params = {
    createdBy: $util.getItem('userInfo').username,
    projectName: $('#projectName').val()
  }
  $.ajax({
    url: API_BASE_URL + '/project/queryProjectList',
    type: "POST",
    data: JSON.stringify(params),
    dataType: "json",
    contentType: "application/json",
    success(res) {
      projectList = Array.from(res.data)
      $('#content').html('')
...
const searchProjectList = () => {
  ...
  $.ajax({
    url: API_BASE_URL + '/project/selectProjectByName',
    type: "POST",
    data: JSON.stringify(params),
    dataType: "json",
    contentType: "application/json",
...
const onDelProject = (pid) => {
  ...
  if (state) {
    ...
    $.ajax({
      url: API_BASE_URL + '/project/deleteProjectById',
      type: "POST",
      data: JSON.stringify(params),
      dataType: "json",
      contentType: "application/json",
