        ...
        $('#table #tbody').append(`
          <tr>
            ...
            <td>
              ...
              <button type="button" class="btn btn-link btn-red" onclick="handleCloseUser('${item.username}')">关闭</button>
              <button type="button" class="btn btn-link btn-red" onclick="handleDeleteUser('${item.username}')">删除</button>
            </td>
          </tr>
        `)
      })
...
const handleCloseUser = (username) => {
  let params = {
    username: username
  }
  $.ajax({
    url: API_BASE_URL + '/admin/closeUser',
    type: 'POST',
    data: JSON.stringify(params),
    dataType: 'json',
    contentType: 'application/json',
...
const handleDeleteUser = (username) => {
  ...
  $.ajax({
    url: API_BASE_URL + '/admin/deleteUser',
    type: 'POST',
    data: JSON.stringify(params),
    dataType: 'json',
    contentType: 'application/json',
